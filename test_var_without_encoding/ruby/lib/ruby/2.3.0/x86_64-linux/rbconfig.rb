...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/av-manager/ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/av-manager/ruby'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/local/av-manager/ruby"
